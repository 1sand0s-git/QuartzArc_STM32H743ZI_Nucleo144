...
private:
	...
	GPIO_TypeDef*        m_pGPIO;       //Stores the GPIO port of the current output pin. A member of GPIO_TypeDef as defined in stm32f743xx.h
...
protected:
	...
	GPIO_TypeDef*     m_pGPIO;      //Stores the GPIO port of the current input pin. A member of GPIO_TypeDef as defined in stm32f743xx.h
